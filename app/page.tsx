          ...
          <div className="row">
            ...
            <div className="plans-box">
              <div className="plan">
                ...
                <Link onClick={handleClick} href="https://api.whatsapp.com/send?phone=11979929079" target="_blank" className='btn-green' id='btn-criar-meu-site-plano-basic'>Criar meu site</Link>
              </div>
              <div className="plan plan-spotlight">
                ...
                <Link onClick={handleClick}  href="https://api.whatsapp.com/send?phone=11979929079" target='_blank' className='btn-green'id='btn-criar-meu-site-plano-business'>Criar meu site</Link>
              </div>
              <div className="plan">
                ...
                <Link onClick={handleClick} href="https://api.whatsapp.com/send?phone=11979929079" target='_blank' className='btn-green' id='btn-criar-meu-site-plano-enterprise'>Criar meu site</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-right">
              ...
              <Link onClick={handleClick} href="https://api.whatsapp.com/send?phone=11979929079" target='_blank' className='btn-green' id='btn-entrar-em-contato'>Entrar em contato</Link>
            </div>
            <div className="col-left">
