...
const EnviarEmail = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input type="text" name="email" placeholder="Informe seu Email" onChange={handleChange} />
      <textarea name="message" placeholder="Deixe sua mensagem" onChange={handleChange} />
      <p>{message}</p> {/* Exibe a mensagem aqui */}
      <button type="submit" className="btn-green" id="btn-enviar-formulario">
        Enviar
      </button>
    </form>
  )
